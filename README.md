...
* Documentation is built with
  [Starlight](https://starlight.astro.build) (Astro) using
  [Bun](https://bun.sh); the Python API reference is generated by
  [griffe2md](https://github.com/pawamoy/griffe2md)
...
├── astro.config.mjs   <- Starlight (Astro) documentation site configuration.
...
├── docs               <- Starlight documentation site (pages in docs/content/docs)
